...
public class MarchingCubeLUT {
	public Hashtable<Byte, Cube> McLut = new Hashtable<Byte, Cube>();
	...
	private void add0(Byte value, LinkedList<points[]> planes) {
		// New cube
	...
	private void add1(Byte value, LinkedList<points[]> planes) {
		// New cube
		Cube newCube = new Cube(value, planes);
		McLut.put(value, newCube);
		// Inverted Cube
